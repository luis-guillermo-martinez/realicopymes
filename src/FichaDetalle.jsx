...
function FichaDetalle() {
  ...
  // Galería: 3 fotos Destacado / 5 Patrocinado (NUNCA la foto de perfil)
  const galeria = getGaleria().slice(0, esPatrocinado ? 5 : 3)
      ...
      <header className={`relative overflow-hidden text-white py-12 ${bannerDeFondo ? '' : 'bg-gradient-to-b from-navy to-navy-dark'}`}>
        ...
        <div className="container mx-auto px-4 relative">
          <div className="flex flex-col md:flex-row gap-8 items-start">
            {/* FOTO DE PERFIL REDONDA Y ESTÁTICA */}
            {tieneFoto && (
              <div className="flex-shrink-0 mx-auto md:mx-0">
                {negocio.foto_portada ? (
                  <div className={`w-40 h-40 md:w-48 md:h-48 rounded-full overflow-hidden border-4 bg-white ${
      ...
      <main className="container mx-auto px-4 py-12 flex-grow">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            {/* GALERÍA: solo fotos de galería, clic = visor lupa */}
            ...
            {/* CONTACTO: botones debajo de cada dato */}
            <section className="bg-white p-6 rounded-xl shadow-md">
